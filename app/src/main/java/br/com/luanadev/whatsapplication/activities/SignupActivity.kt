...
import br.com.luanadev.whatsapplication.util.DATA_USERS
import br.com.luanadev.whatsapplication.util.User
...
class SignupActivity : AppCompatActivity() {
    ...
    fun onSignup(v: View){
        ...
        if (nameET.text.isNullOrEmpty()){
            nameTIL.error= "Email is requered"
            nameTIL.isErrorEnabled = true
            proceed = false
        }
        if (phoneET.text.isNullOrEmpty()){
            phoneTIL.error= "Email is requered"
            phoneTIL.isErrorEnabled = true
            proceed = false
        }
        if (emailET.text.isNullOrEmpty()){
            emailTIL.error= "Email is requered"
            emailTIL.isErrorEnabled = true
            proceed = false
        }
        if (passwordET.text.isNullOrEmpty()){
            passwordTIL.error= "Email is requered"
